...
export default function AirFreightPage() {
  ...
  const handleQuoteSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const whatsappMsg = encodeURIComponent("Hi, I would like to request an Air Freight quote. Here are my details: ");
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="bg-[#0A0F1C] rounded-3xl p-8 md:p-12 border border-[#D4AF37]/30 shadow-[0_0_50px_rgba(212,175,55,0.05)] relative overflow-hidden">
            ...
            <div className="text-center mb-10 relative z-10">
              ...
              <p className="text-white/60">Fill in the cargo details and get an instant response via WhatsApp from our freight agents.</p>
            </div>
            ...
            <form onSubmit={handleQuoteSubmit} className="space-y-6 relative z-10">
              ...
              <button type="submit" className="w-full bg-[#D4AF37] hover:bg-[#F3C332] text-black font-bold py-4 rounded-xl transition-all shadow-[0_0_20px_rgba(212,175,55,0.2)] text-lg flex items-center justify-center gap-2">
                <MessageCircle className="w-6 h-6" /> Get Quote on WhatsApp
              </button>
            </form>
          </div>
        </div>
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="flex flex-col justify-center">
              ...
              <a href="https://wa.me/1234567890" target="_blank" rel="noreferrer" className="inline-flex items-center justify-center gap-2 bg-white/10 hover:bg-white/20 text-white font-bold px-8 py-4 rounded-xl border border-white/10 transition-all text-lg w-full sm:w-auto">
